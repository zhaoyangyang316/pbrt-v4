...
// SimpleRISIntegrator
SimpleRISPathIntegrator::SimpleRISPathIntegrator(int maxDepth, bool sampleLights,
...
std::string SimpleRISPathIntegrator::ToString() const {
...
std::unique_ptr<SimpleRISPathIntegrator> SimpleRISPathIntegrator::Create(
    ...
    return std::make_unique<SimpleRISPathIntegrator>(maxDepth, sampleLights, sampleBSDF,
...
std::unique_ptr<Integrator> Integrator::Create(
    ...
    if (name == "path")
        ...
        integrator = SimplePathIntegrator::Create(parameters, camera, sampler, aggregate,
                                                  lights, loc);
    else if (name == "simplerispath")
        integrator = SimpleRISPathIntegrator::Create(parameters, camera, sampler, aggregate,
                                                  lights, loc);
